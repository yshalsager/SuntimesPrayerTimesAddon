...
- يعرض خطاً زمنياً في Home (يمكن السحب يميناً/يساراً بين أمس/اليوم/غداً) وقائمة شهرية ببطاقات الأيام (Days).
...
- يمكن الضغط على صلاة داخل Home لفتح محرّر منبّهات المضيف مع اختيار الحدث مسبقاً (منبّهات الأحداث تتتبع تغيّر المواقيت تلقائياً، ويمكن ضبط الإزاحة +/-30 دقيقة من واجهة المضيف).
