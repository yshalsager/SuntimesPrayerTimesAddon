...
internal fun build_days_sig(
    ...
    listOf(
        ...
        Prefs.get_extra_fajr_1_enabled(ctx).toString(),
        Prefs.get_extra_fajr_1_angle(ctx).toString(),
        Prefs.get_extra_fajr_1_label(ctx),
        Prefs.get_isha_mode(ctx),
        Prefs.get_isha_angle(ctx).toString(),
        Prefs.get_isha_fixed_minutes(ctx).toString(),
        Prefs.get_extra_isha_1_enabled(ctx).toString(),
        Prefs.get_extra_isha_1_angle(ctx).toString(),
        Prefs.get_extra_isha_1_label(ctx),
